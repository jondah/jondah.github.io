...
date: '2017-06-20T20:15:36+00:00'
author: jonas
layout: post
guid: 'http://blog.jonasdahlgren.se/?p=121'
permalink: /2017/06/20/fix-vmware-tools-not-running-on-windows-servers/
categories:
    - powercli
    - powershell
---
...
if ($vm -match “^(?&lt;Name&gt;\\S\*)\\s.\*$”) { $vm\_name = $Matches.Name }  
else { $vm\_name = $vm }

$vm\_hostname = $vm\_name.name +”.domain.local”

if (Test-Connection -Computername $vm\_hostname -BufferSize 16 -Count 1 -Quiet)  
{  
Invoke-Command -Computername $vm\_hostname -ScriptBlock { stop-Service -name vmvss; start-service vmvss } -Credential $cred  
Write-Host “Service restarted on $vm\_name”  
}  
Else  
{  
Write-Host -ForegroundColor Red “Unable to contact $vm\_name”  
}

}  
}  
\#Disconnect from Vcenter.  
Disconnect-VIServer vcenter -Confirm:$false\[/code\]