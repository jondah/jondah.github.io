...
date: '2024-10-13T19:10:00+00:00'
author: jdahlgren
layout: post
guid: 'https://blog.jonasdahlgren.se/?p=1797'
permalink: /2024/10/13/automate-azure-vnet-subnet-export-to-phpipam/
firehose_sent:
    - '1728841732'
    - '1728841732'
    - '1728841732'
...
reader_suggested_tags:
    - '["Azure","Cloud","Python","Microsoft","Security"]'
    - '["Azure","Cloud","Python","Microsoft","Security"]'
    - '["Azure","Cloud","Python","Microsoft","Security"]'
    - '["Azure","Cloud","Python","Microsoft","Security"]'
    - '["Azure","Cloud","Python","Microsoft","Security"]'
...
<figure class="wp-block-image size-large">![](http://192.168.5.181/wp-content/uploads/2024/10/azure-vnet-1.png?w=1024)</figure>This is the setup in Azure. A VNET with several subnets.

<figure class="wp-block-image size-large">![](http://192.168.5.181/wp-content/uploads/2024/10/2024-10-11-20_19_11-phpipam-_-subnets-_-azure.png?w=1024)</figure>In phpipam only the VNET address space is documented. I want the subnets to have 10.0.0.0/20 as a parent subnet inside phpipam. Just like the structure in Azure. To achieve this i decided to write a solution in python. I have splitted the code in to two files. azureadd.py contains the code used for reading VNET and subnet information from azure and call functions in ipam.py that handle the interaction with phpipam.
...
Let’s run the code.   
![](http://192.168.5.181/wp-content/uploads/2024/10/run.png)

Now we can see the end result in phpipam.

![](http://192.168.5.181/wp-content/uploads/2024/10/ipam_done.png)
