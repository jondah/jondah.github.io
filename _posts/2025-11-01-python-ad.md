...
I think i will stick to powershell for Activer directory if it's not a small part of a larger script in python. Python works but it's easier in powershell.
